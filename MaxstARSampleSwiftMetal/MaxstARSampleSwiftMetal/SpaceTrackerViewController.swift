...
class SpaceTrackerViewController: UIViewController, MTKViewDelegate {
    ...
    func startEngine() {
        ...
        if(trackingManager.isFusionSupported()) {
            ...
            let spaceTrackerMapPath:String = Bundle.main.path(forResource: "iosMap", ofType: "mmap", inDirectory: "data/SDKSample")!
    ...
    func draw(in view: MTKView) {
        if let drawable = view.currentDrawable {
            ...
            if(trackingCount > 0 && fusionState == 1) {
                ...
                textureCube.setScale(x: 0.1, y:  0.1, z: 0.1)
