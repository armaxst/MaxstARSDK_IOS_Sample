...
class ObjectFusionTrackerViewController: UIViewController, MTKViewDelegate {
    ...
    func startEngine() {
        ...
        if(trackingManager.isFusionSupported()) {
            ...
            let objectTrackerMapPath:String = Bundle.main.path(forResource: "obj_230105_25", ofType: "3dmap", inDirectory: "data/SDKSample")!
            trackingManager.addTrackerData(objectTrackerMapPath)
            trackingManager.addTrackerData("{\"object_fusion\":\"set_length\",\"object_name\":\"obj_230105_25\", \"length\":0.198}");
