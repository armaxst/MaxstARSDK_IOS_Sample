...
class QRCodeFusionTrackerViewController: UIViewController, MTKViewDelegate {
    ...
    func draw(in view: MTKView) {
        ...
        if let drawable = view.currentDrawable {
            ...
            if trackingCount > 0 && fusionState == 1 {
                ...
                textureCube!.setScale(x: 0.14, y: 0.14, z: 0.001)
    ...
    func startEngine() {
        ...
        if(trackingManager.isFusionSupported()) {
            ...
            trackingManager.addTrackerData("{\"qr_fusion\":\"set_scale\",\"content\":\"Maxst1\", \"scale\":0.063}");
            trackingManager.addTrackerData("{\"qr_fusion\":\"set_scale\",\"content\":\"Maxst2\", \"scale\":0.063}");
